...
type SortField = "weapon" | "serialNumber" | "user" | "personalNumber" | "division" | "assignedAt" | "assignedBy";
type SortDirection = "asc" | "desc";

export function WeaponsTable({ assignments }: { assignments: Assignment[] }) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 shadow-sm">
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-xl font-bold text-zinc-50">נשקים מוקצים</h2>
          <p className="mt-1 text-sm text-zinc-400">
            סה"כ {filteredAssignments.length} נשקים
          </p>
        </div>
