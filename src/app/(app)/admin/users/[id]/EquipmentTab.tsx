                ...
                return (
                  <tr key={assignment.id} className="border-b border-zinc-800 hover:bg-zinc-900/50 transition-colors">
                    ...
                    <td className="px-4 py-4 text-center">
                      <div className="inline-flex items-center justify-center px-3 py-1 rounded-lg border border-zinc-700 bg-zinc-800 text-sm font-bold text-zinc-50">{assignment.quantity}</div>
                    </td>
                    ...
                    <td className="px-4 py-4 text-sm text-zinc-400">{new Date(assignment.assignedAt).toLocaleDateString("he-IL")}</td>
                  ...
                  {userBox.items.map((boxItem: BoxItemData) => (
                    <tr key={boxItem.id} className="border-b border-zinc-800 hover:bg-zinc-900/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="inline-flex items-center justify-center px-3 py-1 rounded-lg border border-amber-900/40 bg-amber-900/20 text-sm font-bold text-amber-400">{boxItem.quantity}</div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-sm text-zinc-400">{new Date(boxItem.movedAt).toLocaleDateString("he-IL")}</td>
                      <td className="px-4 py-3 text-center">
                        <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg rounded-3xl bg-zinc-900 p-8 shadow-2xl border border-zinc-800 animate-in fade-in zoom-in duration-200">
            ...
            <div className="mb-6 p-4 rounded-xl border border-zinc-800 bg-zinc-950">
              ...
              {unassignModal.assignment.serialNumber && <div className="text-sm text-zinc-400 mt-1">מספר סידורי: <span className="font-mono text-zinc-300">{unassignModal.assignment.serialNumber}</span></div>}
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg rounded-3xl bg-zinc-900 p-8 shadow-2xl border border-zinc-800 animate-in fade-in zoom-in duration-200">
            ...
            <div className="mb-6 p-4 rounded-xl border border-amber-900/40 bg-amber-950/10">
              ...
              {moveToBoxModal.assignment.serialNumber && <div className="text-sm text-zinc-400 mt-1">מספר סידורי: <span className="font-mono text-zinc-300">{moveToBoxModal.assignment.serialNumber}</span></div>}
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-lg rounded-3xl bg-zinc-900 p-8 shadow-2xl border border-zinc-800 animate-in fade-in zoom-in duration-200">
            ...
            <div className="mb-6 p-4 rounded-xl border border-blue-900/40 bg-blue-950/10">
              ...
              {restoreModal.boxItem.serialNumber && <div className="text-sm text-zinc-400 mt-1">מספר סידורי: <span className="font-mono text-zinc-300">{restoreModal.boxItem.serialNumber}</span></div>}
            </div>
            <div className="space-y-6">
              <div>
